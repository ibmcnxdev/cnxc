...
if (__GuestModel_serviceDeskURL !== undefined) {
    ...
    var __GuestModel_serviceDeskURL = 'https://www.mmi-consult.de/';

    //  The following two variables hold the IDs of the ACL Communities
    var __GuestModel_firstACL = new __GuestModel_UserAllowed('f791f7ee-6401-47a6-9ce9-da0df86bbb36');
    var __GuestModel_secondACL = new __GuestModel_UserAllowed('bc696f27-7cf4-484c-abb7-60411e5d482c');
}